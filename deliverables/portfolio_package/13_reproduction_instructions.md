...
.venv/bin/python scripts/verify_excel_model.py     # 20 checks

# Power BI handoff package (Milestone 6)
.venv/bin/python scripts/build_powerbi_handoff.py
.venv/bin/python scripts/verify_powerbi_handoff.py  # 57 checks

# Web decision cockpit (Milestone 7)
.venv/bin/python scripts/build_web_cockpit_data.py
.venv/bin/python scripts/verify_web_cockpit.py      # 20 checks, needs Playwright + Chromium
```
